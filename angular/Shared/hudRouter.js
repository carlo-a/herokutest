...
var aorouter = angular.module('HUD-Router', ["ui.router", "mdColorPicker", 'ngSanitize', "ngMaterial", "jQueryScrollbar"]); //
aorouter.factory('principal', ['$q', '$http', '$timeout', function ($q, $http, $timeout) {
...
aorouter.factory('authorization', ['$rootScope', '$state', 'principal', function ($rootScope, $state, principal) {
    return {
        authorize: function () {
...
aorouter.run(['$rootScope', '$state', '$stateParams', 'authorization', 'principal', 'DataFactory', function ($rootScope, $state, $stateParams, authorization, principal, DataFactory) {
...
aorouter.config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
